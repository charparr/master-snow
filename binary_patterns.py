...
binwarp_names = ['Reference', '1/2 Phase Shift', 'Rotate 90','Rotate 45',
                 'Dilation', 'Erosion','Y - Reflection', 'X Shift',
                 'Row Shuffle', 'Affine', 'Gauss', 'Random','Edges']
...
def plot_binary(names, data):
    ...
    fig.subplots.adjust(hspace = 0.5)
    fig.suptitle( 'Fidelity Tests of Binary Patterns' )
