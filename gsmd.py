...
def input_data(path, filename, blur_amount):
    ...
    noise = random_noise( random_noise( random_noise(gray, mode = "gaussian") ))

    return img, gray, blur, noise
...
def gmsd(ref, target):
    ...
    return ref_grad_mag, dst_grad_mag
    ...
    plt.savefig('/home/cparr/Snow_Patterns/figures/gms/gmsd_dancers.png',
...
inputs = input_data('/home/cparr/Downloads/jpeg2000_db/db/', 'dancers.bmp',25)
img = inputs[0]
ref = inputs[1]
target = inputs[2]
noise = inputs[3]
